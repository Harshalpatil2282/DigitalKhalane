 ...
 * Main Server Entry Point (Local Development Only)
...
// In production (non-Vercel), serve the client build files from the dist folder
...
// Skip if running on Vercel (serverless)
